...
**Donate by wire transfer:** E-Mail at *codigoaldea@gmail.com* for wire transfer details. 
...
```
$  git clone https://github.com/CodigoAldea/django-jewelry-shop-main.git
```
